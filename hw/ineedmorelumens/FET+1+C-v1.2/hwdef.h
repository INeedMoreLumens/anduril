// INeedMoreLumens FET+1+C driver layout
...
#define HWDEF_C  ineedmorelumens/FET+1+C-v1.2/hwdef.c
...
// e-switch
#define SWITCH_PIN      PIN6_bp
#define SWITCH_PORT     VPORTA.IN
#define SWITCH_ISC_REG  PORTA.PIN6CTRL
...
#define AUXRGB_R_PIN   PIN5_bp
#define AUXRGB_G_PORT  PORTA
#define AUXRGB_G_PIN   PIN5_bp
#define AUXRGB_B_PORT  PORTA
#define AUXRGB_B_PIN   PIN4_bp

//// Charging status variables
volatile uint8_t is_plugged_in = 0; // plugged in
volatile uint8_t is_charging = 0; // charging

inline void charging_detect() {
	PORTA.DIRCLR = PIN1_bm;   // PA1 input
	PORTA.PIN1CTRL = PORT_PULLUPEN_bm | PORT_ISC_INTDISABLE_gc;
	
	if (VPORTA.IN & PIN1_bm) { //PORTA?
		is_charging = 0;
		} else {
		is_charging = 1;
	}
...
inline void hwdef_setup() {
    ...
    //PORTA.PIN4CTRL = PORT_PULLUPEN_bm; // Blue Aux
    //PORTA.PIN5CTRL = PORT_PULLUPEN_bm; // Green Aux
    PORTA.PIN6CTRL = PORT_PULLUPEN_bm | PORT_ISC_BOTHEDGES_gc;  // eSwitch
    ...
    //PORTB.PIN5CTRL = PORT_PULLUPEN_bm; // Red Aux
